# https://github.com/gregtam/interpreting-decision-trees-and-random-forests/blob/master/Blog%20Code.ipynb
...
def plot_obs_feature_contrib(clf, contributions, features_df, labels, index,
    ...
    Inputs:
    classifier - A Decision Tree or Random Forest classifier object
    ...
    def _edit_axes():
        ...
        if isinstance(clf, DecisionTreeClassifier)\
            ...
            scores = clf.predict_proba(features_df.iloc[index])[0]
...
def plot_single_feat_contrib(feat_name, contributions, features_df,
    ...
    def _get_plot_df():
        ...
        plot_df = pd.DataFrame({'feat_value': features_df.loc[feat_name].tolist(),
                                'contrib': contrib_array
                               })
        return plot_df
