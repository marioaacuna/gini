...
classdef scalebar <handle
	...
	methods
		function hobj = scalebar(varargin)                        
			...
			hobj.hTextX = text(0,0,'','Parent',hAxes,'ButtonDownFcn',@hobj.FcnStartDrag, 'Hor','center', 'Ver','top');
			hobj.hTextY = text(0,0,'','Parent',hAxes,'Rotation',90,'ButtonDownFcn',@hobj.FcnStartDrag, 'Hor','center', 'Ver','bottom');
            ...
            p.addParameter('hTextX_Pos',[nearto(0.1*axisXWidth) / 2, 0.02*-axisYWidth]); %0.02*[axisXWidth, -axisYWidth]);
            p.addParameter('hTextY_Pos',[0.02*-axisXWidth, nearto(0.1*axisYWidth)]);%0.02*[-axisXWidth, axisYWidth]);
